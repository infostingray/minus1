...
const PLATES = [
  {
    url: 'https://images.unsplash.com/photo-1706464662649-5b075ef6e5af?w=1600&q=85&auto=format&fit=crop',
    title: 'The Approach',
  ...
  {
    url: 'https://images.unsplash.com/photo-1637935142056-03d421b2b13c?w=1600&q=85&auto=format&fit=crop',
    title: 'Site I',
  ...
  {
    url: 'https://images.unsplash.com/photo-1624664929067-5bc278a7c57e?w=1600&q=85&auto=format&fit=crop',
    title: 'Golden Hour',
    location: 'Liwa Oasis',
    tag: 'CONTEXT',
  ...
  {
    url: 'https://images.unsplash.com/photo-1660313140427-aedb86597570?w=1600&q=85&auto=format&fit=crop',
    title: 'Concealed Threshold',
    location: 'Site VII · GCC',
    tag: 'EXTERIOR',
    aspect: 'aspect-[5/4]',
    span: 'md:col-span-3',
  },
  {
    url: 'https://images.unsplash.com/photo-1637935068558-a1f39612620d?w=1600&q=85&auto=format&fit=crop',
    title: 'Rub al Khali',
    location: 'Sector IV · Bespoke',
    tag: 'LANDSCAPE',
    aspect: 'aspect-[4/3]',
    span: 'md:col-span-7',
  },
  {
    url: 'https://images.unsplash.com/photo-1660313096407-73b597e742e3?w=1600&q=85&auto=format&fit=crop',
    title: 'Sand Study',
    location: 'Texture Plate',
    tag: 'MATERIAL',
    aspect: 'aspect-[4/3]',
    span: 'md:col-span-5',
  },
