    ...
    <>
      <div className="preloader">
        ...
        <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", gap: 24 }}>
          ...
          <div className="f-mono" style={{ fontSize: 10, letterSpacing: "0.3em", color: "var(--ash)", marginTop: -14 }}>BUNKERS · DOMES</div>
    ...
    <header className="grain" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 80, background: scrollY > 60 ? "rgba(5,5,5,0.78)" : "linear-gradient(180deg, rgba(0,0,0,0.5), transparent)", backdropFilter: scrollY > 60 ? "blur(14px)" : "none", WebkitBackdropFilter: scrollY > 60 ? "blur(14px)" : "none", borderBottom: scrollY > 60 ? "1px solid var(--line)" : "1px solid transparent", transition: "all 400ms ease" }}>
      <div className="flex items-center justify-between" style={{ padding: "20px 28px" }}>
        ...
        <nav className="hidden md:flex items-center" style={{ gap: 30 }}>
          {[["domes", "01 — Domes"], ["bunkers", "02 — Bunkers"], ["tiers", "03 — Tiers"], ["process", "04 — Process"], ["capabilities", "05 — Specs"], ["contact", "06 — Contact"]].map(([h, t]) => (
        ...
        {open && (
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.4, ease: [0.7, 0, 0.2, 1] }} className="md:hidden hair-t" style={{ overflow: "hidden", background: "var(--ink)" }}>
            <div className="flex flex-col py-4 px-7">
              {[["domes", "01 — Domes"], ["bunkers", "02 — Bunkers"], ["tiers", "03 — Tiers"], ["process", "04 — Process"], ["capabilities", "05 — Specs"], ["contact", "06 — Contact"]].map(([h, t], i) => (
    ...
    <section id="top" style={{ height: "100vh", position: "relative" }} className="grain vignette">
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "none", zIndex: 7 }}>
        <Magnetic strength={0.4}>
          <div style={{ width: 88, height: 88, border: "1px solid var(--line-3)", background: "rgba(5,5,5,0.6)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--bone)" }} className="glow-gold">
...
function DomesShowcase() {
  ...
  return (
    <section id="domes" ref={ref} className="grain hair-b" style={{ position: "relative", background: "var(--carbon)", padding: "160px 0", overflow: "hidden" }}>
      <div className="mx-auto" style={{ maxWidth: 1320 }}>
        <div style={{ padding: "0 32px" }}>
          <div className="flex items-center" style={{ gap: 14, marginBottom: 32 }}>
            <Sun size={14} color="var(--gold)" /><Label color="var(--gold)">01 — DOMES</Label>
          </div>
          <div className="flex flex-wrap items-end justify-between" style={{ gap: 24, marginBottom: 64 }}>
            <h3 className="f-display" style={{ fontSize: "clamp(2.4rem, 6vw, 5.6rem)", lineHeight: 0.94, color: "var(--bone)", maxWidth: 800 }}>
              Above the line.<br /><span style={{ color: "var(--gold)" }}>Engineered for the sun.</span>
            </h3>
            <p className="f-body t-bone-dim" style={{ fontSize: 14.5, lineHeight: 1.65, maxWidth: 360 }}>
              Geodesic enclosures sculpted into the terrain. Solar-managed, climate-sealed, acoustically isolated — the surface residence as discreet object.
            </p>
          </div>

          <div style={{ position: "relative", height: 540, overflow: "hidden", background: "var(--steel)" }}>
            <motion.div style={{ position: "absolute", inset: "-15% -5%", backgroundImage: `url(${IMG.domesAlt}), linear-gradient(135deg, #2a2520, #1a1610)`, backgroundSize: "cover", backgroundPosition: "center", y, scale, filter: "grayscale(15%) contrast(1.08) brightness(0.65) sepia(0.08)" }} />
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(10,10,10,0.4), rgba(10,10,10,0.1) 40%, rgba(10,10,10,0.85))" }} />
            <div style={{ position: "absolute", left: 28, top: 28, display: "flex", gap: 8, alignItems: "center" }}>
              <Hexagon size={12} color="var(--gold)" /><Label color="var(--bone)">SURFACE GEODESIC</Label>
            </div>
            <div style={{ position: "absolute", right: 28, top: 28 }}><Label color="var(--bone-dim)">SOLAR-MANAGED</Label></div>
            <div style={{ position: "absolute", left: 28, bottom: 28, right: 28, display: "flex", flexWrap: "wrap", justifyContent: "space-between", gap: 24, alignItems: "flex-end" }}>
              <div>
                <div className="f-display" style={{ fontSize: "clamp(1.8rem, 4.2vw, 3.4rem)", lineHeight: 0.95, color: "var(--bone)" }}>A residence,<br />held by the horizon.</div>
              </div>
              <div style={{ textAlign: "right" }}>
                <Label color="var(--gold)">ENVELOPE</Label>
                <div className="f-display big-num" style={{ fontSize: 36, color: "var(--bone)", marginTop: 4 }}>120 – 800 m²</div>
              </div>
            </div>
            <div className="bracket tl" /><div className="bracket tr" /><div className="bracket bl" /><div className="bracket br" />
          </div>
    ...
    <section id="bunkers" ref={ref} className="grain" style={{ position: "relative", background: "var(--ink)", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "180px 32px" }} className="mx-auto">
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          <div className="flex items-center" style={{ gap: 14, marginBottom: 32 }}>
            <ArrowDown size={14} color="var(--gold)" /><Label color="var(--gold)">02 — BUNKERS</Label>
          </div>
          ...
          <div className="grid md:grid-cols-12" style={{ gap: 20 }}>
            <div className="md:col-span-7" style={{ position: "relative", height: 480, overflow: "hidden", background: "var(--steel)" }}>
              ...
              <div style={{ position: "absolute", left: 24, top: 24, display: "flex", gap: 8, alignItems: "center" }}>
                <ArrowDown size={12} color="var(--gold)" /><Label color="var(--bone)">DESCENT CORRIDOR</Label>
              </div>
  ...
  return (
    <section className="grain hair-b" style={{ position: "relative", background: "var(--carbon)", padding: "160px 0", overflow: "hidden" }}>
      ...
      <div className="mx-auto" style={{ position: "relative", maxWidth: 1320 }}>
        <div style={{ padding: "0 32px" }}>
          <div className="flex items-center" style={{ gap: 14, marginBottom: 24 }}>
            <Globe size={14} color="var(--gold)" /><Label color="var(--gold)">07 — TERRITORY</Label>
          </div>
...
function Assistant({ open, onClose, fields, setFields, onSubmit }) {
    ...
    switch (stage) {
      case "start":
        if (/begin|yes|sure|ok|start|continue/i.test(trimmed)) {
          ...
          aiSay("MINUS 1 designs private subterranean and surface environments — bunkers and domes — for principals who require continuity, privacy, and control. Engagement is by appointment only, under NDA.", 1100);
      ...
      case "channel":
        ...
        setTimeout(() => aiSay("Final question — which side of the line interests you? DOMES, BUNKERS, or BOTH?", 900), 1100);
        setStage("interest");
        break;
      case "interest": {
        let normalised = "BOTH";
        if (/dome/i.test(trimmed)) normalised = "DOMES";
        else if (/bunker/i.test(trimmed)) normalised = "BUNKERS";
        else if (/both/i.test(trimmed)) normalised = "BOTH";
  ...
  const suggestionsFor = (s) => {
    switch (s) {
      ...
      case "interest": return ["DOMES", "BUNKERS", "BOTH"];
